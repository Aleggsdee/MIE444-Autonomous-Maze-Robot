...
with open('sensor_data_3_ppi.pkl', 'rb') as f:
...
PORT_SERIAL = 'COM5'    # COM port identification (varies between 5 and 6)
...
print(loaded_sensor_readings[21][129][270])
print(loaded_sensor_readings[21][129][300])
print(loaded_sensor_readings[21][129][330])
print(loaded_sensor_readings[21][129][0])
print(loaded_sensor_readings[21][129][30])
print(loaded_sensor_readings[21][129][60])
print(loaded_sensor_readings[21][129][90])
